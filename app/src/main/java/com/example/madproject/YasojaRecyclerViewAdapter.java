...
public class YasojaRecyclerViewAdapter extends RecyclerView.Adapter<YasojaRecyclerViewAdapter.ViewHolder>  {
    ...
    public YasojaRecyclerViewAdapter(ArrayList<String> mImageNames, ArrayList<String>
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.yasoja_doctor_layout,parent,false);
